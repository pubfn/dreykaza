...
I enjoy writing code and exploring how different systems and algorithms work.

That curiosity is what led me to Rust. It became my main language because I like having to think about what the program is actually doing instead of hiding everything behind abstractions.

Most of my projects come from the same idea: I find something interesting, try to build it myself, and see where that takes me.
...
I'm getting more into **Go and backend development**, especially APIs, databases, concurrency and the parts that go into building a real backend.
